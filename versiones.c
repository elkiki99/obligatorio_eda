...
bool versiones_vacio(Versiones vs)
{
...
{
    // Crea la linea y la inserta en la versión, en el número especificado
    Linea nueva = crear_linea(texto);  // función en linea
    insertar_linea_en_version(v, nueva, nroLinea); // función en lineas
    //imprimir_lineas(lineas(v)); // imprime las lineas
}
